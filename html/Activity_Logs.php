...
<head>
    ...
    <title>AlertPoint Activity Logs</title>
    ...
    <main class="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-6">
            <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 mb-1">Admin Login Logs</h1>
                    <p class="text-gray-600 text-base">View and track administrator login history within the AlertPoint system.</p>
                </div>
        ...
        <!-- REPLACE the Stats Cards section with this updated version that shows filtered data: -->
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            <div class="stat-card hover-card rounded-lg p-6">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-gray-600">Total Login Attempts</p>
                        <p class="text-2xl font-bold text-gray-900"><?php echo $totalAdminLogsAll; ?></p>
            ...
            <div class="stat-card hover-card rounded-lg p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-green-600"><?php echo $successfulLogins; ?></p>
                        <?php if ($filterTimeframe !== 'all'): ?>
                            <p class="text-xs text-gray-500 mt-1">
                                <?php 
                                switch($filterTimeframe) {
            ...
            <div class="stat-card hover-card rounded-lg p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-red-600"><?php echo $failedLogins; ?></p>
                        <?php if ($filterTimeframe !== 'all'): ?>
                            <p class="text-xs text-gray-500 mt-1">
                                <?php 
                                switch($filterTimeframe) {
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-blue-600">
                            <?php 
                            $successRate = $totalAdminLogsAll > 0 ? round(($successfulLogins / $totalAdminLogsAll) * 100, 1) : 0;
                            echo $successRate . '%';
                            ?>
                        </p>
                        <?php if ($filterTimeframe !== 'all'): ?>
                    ...
                    class="category-card bg-gradient-to-r from-blue-50 to-blue-100 border border-blue-200 rounded-lg p-4 cursor-pointer hover:shadow-md hover:scale-[1.02] transition-all duration-300 transform">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <span class="inline-block mt-2 text-xs bg-blue-200 text-blue-800 font-semibold px-2 py-1 rounded-full">Active</span>
                            </div>
                    ...
                    class="category-card bg-gradient-to-r from-orange-50 to-orange-100 border border-orange-200 rounded-lg p-4 cursor-pointer hover:shadow-md hover:scale-[1.02] transition-all duration-300 transform">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-sm font-medium text-orange-700 mt-2">View Details</p>
        ...
        <div class="bg-white rounded-xl shadow-lg mb-8" id="admin-login-section">
                ...
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                    ...
                    <div class="flex flex-wrap gap-3">
                        <form method="GET" class="flex flex-wrap gap-3" id="filterForm">
                            <!-- Status Filter -->
                            <select name="status" class="px-3 py-2 border border-gray-300 rounded-md text-sm" onchange="document.getElementById('filterForm').submit()">
            ...
            <div class="p-6">
                <?php if (!empty($adminLogs)): ?>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Previous Session</th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <?php foreach ($adminLogs as $log): 
                                    ...
                                    $statusClass = $log['login_status'] === 'success' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800';
                                    $statusIcon = $log['login_status'] === 'success' ? 'fa-check-circle' : 'fa-times-circle';
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm font-medium text-gray-900">
                                            <?php echo formatDateTime($log['login_time']); ?>
                                        </div>
                                        <div class="text-xs text-gray-500">
                                            <?php echo getTimeAgo($log['login_time']); ?>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">
                                            <?php echo formatDateTime($log['previous_last_active']); ?>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    <div class="flex items-center justify-between mt-6 pt-6 border-t border-gray-200">
                        <div class="text-sm text-gray-500">
                            Showing <?php echo (($currentPage - 1) * $logsPerPage) + 1; ?>-<?php echo min($currentPage * $logsPerPage, $totalAdminLogs); ?> of <?php echo $totalAdminLogs; ?> logs
                        </div>
                        <div class="flex space-x-2">
                            ...
                            ?>
                                <a href="<?php echo $pageUrl; ?>" 
                                   class="px-3 py-2 text-sm rounded-md transition-colors <?php echo $isActive ? 'bg-blue-600 text-white' : 'bg-gray-100 hover:bg-gray-200 text-gray-700'; ?>">
                                    <?php echo $i; ?>
                                </a>
                            <?php endfor; ?>
                ...
                <?php else: ?>
                    ...
                    <div class="text-center py-12">
                        ...
                        <h3 class="text-lg font-medium text-gray-900 mb-2">No Login Logs Found</h3>
                        <p class="text-gray-600 mb-4">
                            <?php if (!empty($searchTerm) || $filterStatus !== 'all' || $filterTimeframe !== 'all'): ?>
                                No logs match your current filters. Try adjusting your search criteria.
                            <?php else: ?>
                                No admin login logs are available at this time.
                            <?php endif; ?>
                        </p>
                        <?php if (!empty($searchTerm) || $filterStatus !== 'all' || $filterTimeframe !== 'all'): ?>
        ...
        <!-- System Actions Section (Coming Soon) -->
        <div class="bg-white rounded-xl shadow-lg mb-8 hidden" id="system-actions-section">
            <div class="p-6 border-b border-gray-200">
                <h2 class="text-xl font-semibold text-gray-900 flex items-center">
                    <i class="fas fa-cogs text-green-600 mr-3"></i>
                    System Actions
                </h2>
                <p class="text-sm text-gray-600 mt-1">Track CRUD operations, alert broadcasts, and system modifications</p>
            </div>
            <div class="p-6">
                <div class="text-center py-12">
                    <div class="w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-4">
                        <i class="fas fa-construction text-gray-400 text-2xl"></i>
                    </div>
                    <h3 class="text-lg font-medium text-gray-900 mb-2">Coming Soon</h3>
                    <p class="text-gray-600">System action logging will be available in a future update.</p>
                </div>
            </div>
        </div>

        <!-- User Activities Section (Coming Soon) -->
        <div class="bg-white rounded-xl shadow-lg mb-8 hidden" id="user-activities-section">
            <div class="p-6 border-b border-gray-200">
                <h2 class="text-xl font-semibold text-gray-900 flex items-center">
                    <i class="fas fa-users text-purple-600 mr-3"></i>
                    User Activities
                </h2>
                <p class="text-sm text-gray-600 mt-1">Monitor resident app interactions and engagement</p>
            </div>
            <div class="p-6">
                <div class="text-center py-12">
                    <div class="w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-4">
                    ...
                    <h3 class="text-lg font-medium text-gray-900 mb-2">Coming Soon</h3>
                    <p class="text-gray-600">User activity logging will be available in a future update.</p>
                </div>
            </div>
        </div>
    </main>
...
<div id="profileModal" class="fixed inset-0 z-40 flex items-center justify-center bg-black bg-opacity-50 hidden">
        ...
        <div class="bg-white rounded-xl shadow-2xl w-full max-w-4xl mx-4 max-h-[95vh] overflow-y-auto">
            ...
            <div class="p-6">
                <div class="text-center py-8">
                    ...
                    <h3 class="text-lg font-medium text-gray-900 mb-2">Profile Feature</h3>
                    <p class="text-gray-600">Profile functionality will be implemented soon.</p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="text-center mb-6">
                    ...
                    <div class="bg-yellow-50 border border-yellow-200 p-3 rounded-lg mb-4">
                        <div class="flex items-center justify-center space-x-2 text-sm text-yellow-800">
                            ...
                            <span>Only logs from before <?php echo date('Y-m-d', strtotime('-90 days')); ?> will be deleted</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="p-6">
                <div class="text-center mb-6">
                    ...
                    <div class="bg-blue-50 border border-blue-200 p-3 rounded-lg mb-4">
                        <div class="flex items-center justify-center space-x-2 text-sm text-blue-800">
                            <i class="fas fa-info-circle text-blue-600"></i>
                            <span>Export includes: <?php echo $totalAdminLogs; ?> log entries</span>
                        </div>
                    </div>
                </div>
    ...
    <script src="/ALERTPOINT/javascript/LOGS/admin_login_logs.js"></script>
